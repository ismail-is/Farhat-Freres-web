...
// import AumarkSlider from "@/components/slider/AumarkSlider"
import AumarkSliders from "@/components/slider/AumarkSliders"
import CitySlider from "@/components/slider/CitySlider"
import G7Slider from "@/components/slider/G7Slider"
...
export default function Aumark() {
                                ...
                                <div className="col-lg-8 col-md-12 " >
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            ...
                                            <p>Le Foton Aumark 2024 est un camion utilitaire lourd offrant de puissantes performances et des caractéristiques de sécurité telles que l'ABS et les airbags. Sa cabine spacieuse, sa technologie moderne et sa grande capacité de chargement en font un véhicule idéal pour le transport fiable et efficace de marchandises.</p>
                                        </div>
                                            ...
                                            <div className="tf-listing-info">
                                                <div id="tf-features">
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Contrôle électronique de stabilité </div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Cabine en acier renforcé pour la protection contre les chocs </div>
                                                    ...
                                                    <div className="features-item">
                                                        <h5 className="features-type-title">Extérieur</h5>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Phares halogènes</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Feux de jour</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Pare-chocs avant en acier</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Rétroviseurs larges</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Jantes en alliage</div>
                                                      
                                                        {/* <div className="listing-feature-wrap"><i className="icon-Vector-32" />Navigation system</div> */}
                                                    </div>
                                                    <div className="features-item">
                                                        <h5 className="features-type-title">Intérieur</h5>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Climatisation : contrôle climatique à deux zones</div>
                                                            <div className="listing-feature-wrap"><i className="icon-Vector-32" />Siège conducteur réglable
                                                            </div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Système d'infodivertissement à écran tactile</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Connectivité Bluetooth</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Siège central rabattable pour plus d'espace  </div>
                                                    ...
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Régulateur de vitesse</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Ports USB</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Large espace de chargement pour une utilisation commerciale</div>
                            ...
                            <div className="related-single-listing swiper">
                                ...
                                <Swiper {...swiperOptions} className="swiper-wrapper">
                                    ...
                                    <Link href='/ViewC2'>
                                        ...
                                        <div className="listing-item-content">
                                            <div className="listing-top-content">
                                                <h6 className="title"><Link href="/ViewC2">Foton View C2 </Link></h6>
                                                {/* <div className="review-wrap">
                                                    <div className="rating">
                                                        <i className="icon-Vector3" />
                                                        <i className="icon-Vector3" />
