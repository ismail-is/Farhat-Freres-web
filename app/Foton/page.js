        ...
        <>
            ...
            <Layout headerStyle={3} footerStyle={1}>
                <div>
                    ...
                    <div className="widget-banner-car-listing banner-car-listing-list-car" style={{backgroundImage: "url('/assets/images/brandBanner/Fotonbanner.webp')"}}>
                        <div className="themesflat-container full" style={{marginTop:'30px'}}>
                            <div className="banner-car-listing">
                                ...
                                {/* <h1 className="title text-white"> <span className="text-red">Foton </span> </h1> */}
                            </div>
                        </div>
                    </div>
                    {/* car-listing-list */}
                                        ...
                                        <div className={activeIndex == 1 ? "tab-pane fade show active" : "tab-pane fade"}>
                                            ...
                                            <Link href='/G7'>
                                                <div className="listing-grid-item">
                                                    ...
                                                    <div className="listing-item-content">
                                                        <div className="listing-top-content">
                                                            <h6 className="title"><a href="#" /><a href="#">Tunland - G7                      </a></h6>
                                                ...
                                                <div className="listing-grid-item">
                                                    ...
                                                    <div className="listing-item-content">
                                                        <div className="listing-top-content">
                                                            <h6 className="title"><a href="#">Tunland - E5</a></h6>
                                                            {/* <div className="review-wrap">
                                                                <div className="rating">
                                                                    <i className="icon-Vector3" />
                                                                    <i className="icon-Vector3" />
                                                ...
                                                <div className="listing-grid-item">
                                                    ...
                                                    <div className="listing-item-content">
                                                        <div className="listing-top-content">
                                                            <h6 className="title"><a href="#">Foton View -C2</a></h6>
                                                            {/* <div className="review-wrap">
                                                                <div className="rating">
                                                                    <i className="icon-Vector3" />
                                                                    <i className="icon-Vector3" />
                                                ...
                                                <div className="listing-grid-item">
                                                    ...
                                                    <div className="listing-item-content">
                                                        <div className="listing-top-content">
                                                            <h6 className="title"><a href="#">Foton TM  </a></h6>
                                                            {/* <div className="review-wrap">
                                                                <div className="rating">
                                                                    <i className="icon-Vector3" />
                                                                    <i className="icon-Vector3" />
                                                ...
                                                <div className="listing-grid-item">
                                                    ...
                                                    <div className="listing-item-content">
                                                        <div className="listing-top-content">
                                                            <h6 className="title"><a href="#">Foton Tohano                                                            </a></h6>
                                                            {/* <div className="review-wrap">
                                                                <div className="rating">
                                                                    <i className="icon-Vector3" />
                                                                    <i className="icon-Vector3" />
                                                ...
                                                <div className="listing-grid-item">
                                                    ...
                                                    <div className="listing-item-content">
                                                        <div className="listing-top-content">
                                                            <h6 className="title"><a href="#">Aumark</a></h6>
                                                            {/* <div className="review-wrap">
                                                                <div className="rating">
                                                                    <i className="icon-Vector3" />
                                                                    <i className="icon-Vector3" />
