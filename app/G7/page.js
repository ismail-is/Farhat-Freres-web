                        ...
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div><h3 style={{textAlign:'center',fontFamily:'initial',marginTop:"-10px",fontWeight:"600",fontSize:'40px'}}>Foton  <span style={{color:"red"}}>G7</span>  2024</h3></div>
                                ...
                                <div className="col-lg-8 col-md-12 " >
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            ...
                                            <p>Le Foton Tunland G7 2024 est un pick-up polyvalent doté d'un design robuste, d'un intérieur spacieux et d'une technologie moderne. Avec des performances fiables, une capacité de remorquage impressionnante et des caractéristiques de sécurité essentielles, il est idéal pour le travail et les aventures de loisir.</p>
                                        </div>
                                            ...
                                            <div className="tf-listing-info">
                                                <div id="tf-features">
                                                    ...
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Feux de brouillard avant</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Marchepieds latéraux</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Aileron arrière</div>
