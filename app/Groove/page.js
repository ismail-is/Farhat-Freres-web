                        ...
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div><h3 style={{textAlign:'center',fontFamily:'initial',marginTop:"-10px",fontWeight:"600",fontSize:'40px'}}>Chevrolet <span style={{color:"red"}}>Groove</span>  2024</h3></div>
                                ...
                                <div className="col-lg-8 col-md-12 " >
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            ...
                                            <p>Le Chevrolet Groove 2024 est un SUV compact et élégant conçu pour la vie urbaine moderne. Son design audacieux, son intérieur spacieux et sa technologie avancée rendent chaque trajet agréable et pratique. Avec un moteur économe en carburant, des dispositifs de sécurité intelligents et un système d'infodivertissement intuitif, le Groove 2024 offre un mélange parfait de style, de confort et de performance pour les explorateurs urbains.</p>
                                        </div>
                                                    ...
                                                    <div className="col-xl-6 col-md-6 item">
                                                        <div className="inner listing-infor-box">
                                                            ...
                                                            <div className="content-listing-info">
                                                                ...
                                                                <p className="listing-info-value"> 15.9 kmpl</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-xl-6 col-md-6 item">
                            ...
                            <div className="related-single-listing swiper">
                                ...
                                <Swiper {...swiperOptions} className="swiper-wrapper">
                                    ...
                                    <Link href='/Captiva'>
                                                ...
                                                <div className="wrap-hover-listing">
                                                    <div className="listing-item active" title="">
                                                        <div className="images">
                                                            <img src="./assets/images/All imgs/Captiva/Captiva 2.webp" className="swiper-image tfcl-light-gallery" alt="images" />
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="listing-item-content">
                                            <div className="listing-top-content">
                                                <h6 className="title"><Link href="/Captiva">Captiva  </Link></h6>
                                    ...
                                    <Link href='/N400'>
                                        <div className="listing-item-image">
                                            <div className="hover-listing-image">
                                                <div className="wrap-hover-listing">
                                                    <div className="listing-item active" title="">
                                                        <div className="images">
                                                            <img src="./assets/images/All imgs/N400/N400 3.webp" className="swiper-image tfcl-light-gallery" alt="images" />
                                                        </div>
                                                    </div>
                                                    {/* <div className="listing-item" title="">
                                                        <div className="images">
                                        ...
                                        <div className="listing-item-content">
                                            <div className="listing-top-content">
                                                <h6 className="title"><Link href="/N400">N400 </Link></h6>
                                                {/* <div className="review-wrap">
                                                    <div className="rating">
                                                        <i className="icon-Vector3" />
                                                        <i className="icon-Vector3" />
