...
export default function HondaBikes () {
    ...
    return (
        <>
            ...
            <Layout headerStyle={3} footerStyle={1}>
                <div>
                    <div className="widget-banner-car-listing banner-car-listing-list-car" style={{backgroundImage: "url('/assets/images/brandBanner/Bikesbanner.webp')"}}>
                                        ...
                                        <div className={activeIndex == 1 ? "tab-pane fade show active" : "tab-pane fade"}>
                                            ...
                                            <Link href='/XL125'>
                                                ...
                                                <div className="listing-grid-item">
                                                    ...
                                                    <div className="listing-item-content">
                                                        <div className="listing-top-content">
                                                            <h6 className="title"><a href="#"> Honda Wave 110</a></h6>
                                                            {/* <div className="review-wrap">
                                                                <div className="rating">
                                                                    <i className="icon-Vector3" />
                                                                    <i className="icon-Vector3" />
