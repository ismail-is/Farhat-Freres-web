...
import TmSlider from "@/components/slider/TmSlider"
                                ...
                                <div className="col-lg-8 col-md-12 " >
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            ...
                                            <p>Le Foton TM 2024 est un camion robuste et durable, conçu pour la performance. Doté d'un moteur puissant, de dispositifs de sécurité avancés et de commodités modernes telles que l'infodivertissement à écran tactile et la climatisation, il assure confort et fiabilité pour les tâches professionnelles et tout-terrain.</p>
                                        </div>
                                            ...
                                            <div className="tf-listing-info">
                                                <div id="tf-features">
                                                    ...
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Feux de brouillard avant</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Calandre chromée</div>
                                                    ...
                                                    <div className="features-item">
                                                        <h5 className="features-type-title">Intérieur</h5>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />A/C : Climatisation</div>
                                                            <div className="listing-feature-wrap"><i className="icon-Vector-32" />Sièges en cuir
                                                            </div>
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Sièges avant réglables et chauffants </div>
