...
import TohanoSlider from "@/components/slider/TohanoSlider"
...
export default function Tohano() {
                                ...
                                <div className="col-lg-8 col-md-12 " >
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            ...
                                            <p>Le Foton Tohano 2024 est un fourgon spacieux conçu pour le confort et la polyvalence. Pouvant accueillir jusqu'à 12 passagers, doté de dispositifs de sécurité avancés et d'une technologie moderne, il est parfait pour le transport familial et l'utilisation professionnelle, offrant fiabilité et commodité pour chaque trajet.</p>
                                        </div>
                                        ...
                                        <div className="wrap-car-feature wrap-style">
                                            ...
                                            <div className="tf-listing-info">
                                                <div id="tf-features">
                                                    ...
                                                    <div className="features-item">
                                                        <h5 className="features-type-title">Extérieur</h5>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Phares LED</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Portes latérales coulissantes</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Feux de brouillard arrière</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Jantes en alliage</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Rétroviseurs électriques</div>
                                                    ...
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Climatisation : contrôle climatique à deux zones</div>
                                                            <div className="listing-feature-wrap"><i className="icon-Vector-32" />Capacité d'accueil de 12 passagers
                                                            </div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Options de sièges en tissu ou en cuir</div>
                                                    ...
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Ports USB multiples</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Régulateur de vitesse</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Large espace de chargement</div>
