...
import Wave110SLider from "@/components/slider/Wave110SLider"
...
export default function Wave110 () {
                        ...
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div><h3 style={{textAlign:'center',fontFamily:'initial',marginTop:"-10px",fontWeight:"600",fontSize:'40px'}}>Honda   <span style={{color:"red"}}>Wave 110</span>  2024</h3></div>
                                ...
                                <div className="col-lg-12 col-md-12 " >
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            ...
                                            <p>La Honda Wave 110 est une moto élégante et efficace conçue pour les déplacements quotidiens. Avec un moteur fiable de 110 cm3, une transmission automatique et un design léger, elle offre une excellente consommation de carburant et une assise confortable, ce qui la rend parfaite pour naviguer sans effort dans le trafic urbain.</p>
                                        </div>
                                            ...
                                            <div className="tf-listing-info">
                                                <div id="tf-features">
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Puissance : Environ 9,3 ch</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Couple : 8,5 Nm</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Transmission : Automatique à 4 vitesses</div>
                                                    ...
                                                    <div className="features-item">
                                                        <h5 className="features-type-title">Extérieur</h5>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Design compact et élégant</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Siège confortable pour le conducteur et le passager</div>
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Forme lisse et aérodynamique</div>
                                                    ...
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Capacité du réservoir de carburant 3,7 litres</div>
