...
export default function ContactUs() {
                ...
                <div >
                    <div className="widget-contact-us">
                        <div className="themesflat-container">
                            <div className="contact-us" style={{marginTop:'130px'}}>
                                <div className="row mb-60">
                                    <div className="col-md-12 col-lg-4">
                                        <div className="contact-us-box">
                                            ...
                                            <Link href="tel:+2250707666660" style={{color:"#696a6f",fontSize:'18px',fontWeight:"500"}}> +225 07 07 66 66 60</Link>
                                        </div>
                                    </div>
                                    <div className="col-md-12 col-lg-4">
                                        <div className="contact-us-box">
  ...
  <svg width={66} height={68} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
                                          ...
                                          <Link href="mailto:Info@farhatfreres.com" style={{color:"#696a6f",fontSize:'18px',fontWeight:"500"}}>Info@farhatfreres.com</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-contact-us-page">
                                    <form action="/" id="form-contact-us-page">
                                        ...
                                        <textarea cols={40} rows={10} aria-invalid="false" defaultValue={"Write Message....."} />
