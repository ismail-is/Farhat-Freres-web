                        ...
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div><h3 style={{textAlign:'center',fontFamily:'initial',marginTop:"-10px",fontWeight:"600",fontSize:'40px'}}>HONDA <span style={{color:"red"}}>HR-V</span>  2024</h3></div>
                                ...
                                <div className="col-lg-8 col-md-12 " >
                                    <div className="post-property">
                                        <div className="wrap-description wrap-style">
                                            ...
                                            <p>The Honda HR-V 2024 offers modern design, advanced safety features and versatile cargo space. Perfect for city driving or weekend trips, it combines fuel efficiency with smooth handling, offering style, comfort and reliability for every journey</p>
                                        </div>
                                            ...
                                            <div className="tf-listing-info">
                                                <div id="tf-features">
                                                    <div className="features-item">
                                                        ...
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Moteur de 158 chevaux</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />AWD en temps réel (disponible)</div>
                                                        <div className="listing-feature-wrap"><i className="icon-Vector-32" />Contrôle de la descente en côte
                                                        </div>
                            ...
                            <div className="related-single-listing swiper">
                                ...
                                <Swiper {...swiperOptions} className="swiper-wrapper">
                                    ...
                                    <Link href='/pilot'>
                                        ...
                                        <div className="listing-item-content">
                                            <div className="listing-top-content">
                                                <h6 className="title"><Link href="/pilot">PILOT </Link></h6>
                                                {/* <div className="review-wrap">
                                                    <div className="rating">
                                                        <i className="icon-Vector3" />
                                                        <i className="icon-Vector3" />
