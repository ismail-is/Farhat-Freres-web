...
export default function BestDeals() {
    return (
        <>
            <div className="widget-best-deals-v2">
                <div className="themesflat-container">
                    <div className="best-deals">
                        <div className="row">
                            <div className="col-12 t-al-center">
                                <div className="heading-section mb-46">
                                    <span className="sub-title mb-6 wow fadeInUp">20% OFF FOR ONLINE BOOKing</span>
                                    <h2 className="title wow fadeInUp">Find the Best Deals</h2>
                                </div>
                            </div>
                        </div>
                        <div className="car-list-item">
                            <div className="tf-car-service">
                                ...
                                <div className="content">
                                    ...
                                    <h6 className="title"><Link href="/dealer-details" /><Link href="/dealer-details">Chevrolet Suburban 2021 mo</Link></h6>
                            ...
                            <div className="tf-car-service">
                                ...
                                <div className="content">
                                    <span className="sub-title">Mini Cooper 3 Similar</span>
                                    <h6 className="title"><Link href="/dealer-details">Chevrolet Suburban 2021 mo</Link></h6>
                                    <span className="price">$27,000</span>
                                    <div className="description">
                                        <ul>
                                            <li className="listing-information fuel">
