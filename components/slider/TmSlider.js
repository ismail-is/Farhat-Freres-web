...
export default function TmSlider() {
        ...
        <>
            <div className="swiper property-gallary2">
                <Swiper
                    ...
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/TM/Foto TM 1..webp" alt="Image" />
                    </SwiperSlide>
                   
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/TM/Foto TM 2.webp" alt="Image" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/TM/Foto TM 3.webp" alt="Image" />
                    </SwiperSlide>
