...
export default function X7slider() {
        ...
        <>
            <div className="swiper property-gallary2">
                <Swiper
                    ...
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/x7/Kaiyi x7 3.webp" alt="Image" />
                    </SwiperSlide>
                   
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/x7/Kaiyi x7.webp" alt="Image" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/x7/Kaiyi x7  2.webp" alt="Image" />
                    </SwiperSlide>
                    
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/x7/Kaiyi x7 4.webp" alt="Image" />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src="./assets/images/All imgs/x7/Kaiyi x7 3.webp" alt="Image" />
                    </SwiperSlide>
